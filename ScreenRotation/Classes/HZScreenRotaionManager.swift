//
//  HZScreenRotaionManager.swift
//  SwiftProject
//
//  Created by zyfMac on 2022/11/12.
//
...
//该类不允许被继承
final class HZScreenRotaionManager: NSObject {

    static let shared = HZScreenRotaionManager()
...
// MARK: - 私有API
private extension HZScreenRotaionManager {
...
// MARK: - 公开API
extension HZScreenRotaionManager {
    /// 旋转至目标方向
    /// - Parameters:
